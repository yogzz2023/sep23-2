...
# List to store the updated filter states for saving to CSV
filter_states = []
...
class CVFilter:
    ...
    def update_step(self, Z):
        ...
        # Append updated state to filter_states list for CSV output
        filter_states.append(self.Sf.flatten().tolist())
...
def main():
    ...
    # Save the updated filter states to a CSV file
    with open('updated_filter_states.csv', 'w', newline='') as csvfile:
